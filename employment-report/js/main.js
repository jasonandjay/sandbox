...
$(function () {
    ...
    waterChart('.chart1', '85')
    waterChart('.chart2', '96')
    ...
    draw('.shoeChart', 100, '完成率', 100, '#09c4ca')
    draw('.clothesChart', 78, '升班率', 100, '#09c4ca')
    draw('.mzChart', 98.5, '就业率', 100, '#09c4ca')
    ...
    function lineChart(ele) {
        ...
        var dataArr = [16.0714,14.5891,14.5891,15.5220,16.6709,17.2820,17.38636];
        // for (var i = 1; i < 13; i++) {
        //     xdata.push(i);
